...
import ViewOrderDetails from 'views/application/orders/OrderDetails';
...
function ConfirmationDialogRaw({ _onClose, value: valueProp, open, ...other }) {
    ...
    return (
        <Dialog TransitionProps={{ onEntering: handleEntering }} aria-labelledby="confirmation-dialog-title" open={open} {...other}>
            {open && (
                <>
                    <DialogTitle id="confirmation-dialog-title">Order Status</DialogTitle>
...
const OrderList = () => {
    ...
    const [value, setValue] = React.useState('Order confirm');
                            ...
                            .map((row, index) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <TableCell align="center" sx={{ border: "2px" }}>
                                            <ListItemButton
                                                divider
                                                aria-haspopup="true"
                                            ...
                                            >
                                                <ListItemText
                                                    primary={<Chip label={value} variant="outlined" />}
                                        ...
                                        <TableCell align="center" sx={{ pr: 3 }}>
                                            {/* <Link to={`/order/order-details/${row.id}`} component={<ViewOrderDetails />} > */}
                                                <IconButton color="primary" size="large" aria-label="view" component={Link} to={`/order/order-details/${row.id}`}>
